                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td width="650" rowspan="2" data-title="image" class="tags">
                                ...
                                <a class="bt_download" href="http://sfrom.net/https://vimeo.com/<?= $Vimeo_Id; ?>"
                                   target="_blank"></a>
                                <?
                                ...
                                <div id="tabs-container">
                                    <ul class="tabs-menu">
                                        <li class="current"><a href="#tab-1"><img
                                                    src="_global/img/btn_a_sphere.png"></a></li>
                                        ...
                                        <div id="tab-1" class="tab-content">
                                            <div class="tabDescr">
                                                ...
                                                <textarea id="sa" class="tags" name="sa"
                                                          placeholder="<?= $nme_Tag_SA_phd ?>"/><?= $getTags_SA; ?></textarea>
                                        ...
                                        <div id="tab-2" class="tab-content">
                                            <div class="tabDescr">
                                                ...
                                                <textarea id="fashion" class="tags" name="fashion"
                                                          placeholder="<?= $nme_Tag_Fashion_phd ?>"/><?= $getTags_Fashion; ?></textarea>
                                        ...
                                        <div id="tab-3" class="tab-content">
                                            <div class="tabDescr">
                                                ...
                                                <textarea id="arts" class="tags" name="arts"
                                                          placeholder="<?= $nme_Tag_Arts_phd ?>"/><?= $getTags_Arts; ?></textarea>
                                        ...
                                        <div id="tab-4" class="tab-content">
                                            <div class="tabDescr">
                                                ...
                                                <textarea id="music" class="tags" name="music"
                                                          placeholder="<?= $nme_Tag_Music_phd ?>"/><?= $getTags_Music; ?></textarea>
                                        ...
                                        <div id="tab-5" class="tab-content">
                                            <div class="tabDescr">
                                                ...
                                                <textarea id="tags" class="tags" name="tags"
                                                          placeholder="<?= $nme_Tag_List_phd ?>"/><?= $getTags_Others; ?></textarea>
                            ...
                            <td width="650" data-title="primary" class="primary flags">
                                ...
                                <div class="CanvasLine<? if (!Check_Title($getAuthor) and empty($CastList)) {
                                    echo '  input_error';
                                } ?>">
                                    <div class="Content_Inline"><?= $nme_Author ?>
                                        <input type="text" class="medium" name="authors"
                                               value="<? if (!isset ($getAuthors)) {
                                                   echo $CastList;
                                               } else {
                                                   echo $getAuthors;
                                               } ?>">
                                    ...
                                    <div class="Content_Inline"><?= $nme_Location ?>
                                        <input type="text" class="short" name="location"
                                               value="<? if (isset ($getLocation)) {
                                                   echo $getLocation;
                                               } else {
                                                   echo $MainUserLocation;
                                               } ?>">
                                    </div>
                                </div>
                                <div class="CanvasLine<? if (!Check_Title($getYear) and empty($Year)) {
                                    ...
                                    <div class="Content_Inline<? if (!Check_Title($getBrand) and empty($Brand)) {
                                        ...
                                        <input type="text" class="short" name="brand"
                                               value="<? if (!isset ($getBrand)) {
                                                   echo $Brand;
                                               } else {
                                                   echo $getBrand;
                                               } ?>">
                                ...
                                <div class="send">
                                    <input type="submit" value="<? if (basename(getcwd()) == "add") {
                                        echo $nme_Send_Video;
                                    } else {
                                        echo $nme_Save_Video;
                                    } ?>"
                                ...
                                <input type="hidden" name="video" value="<? if (!isset ($getVideo)) {
                                    echo $Vimeo_Id;
                                } else {
                                    echo $getVideo;
                                } ?>">
