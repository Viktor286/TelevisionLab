...
// differences from original: string 236 //'position': 'absolute'
...
;(function( $, window, document, undefined ) {
    ...
    var $window = $(window),
        ...
        defaults = {
            ...
            resizable: false, // triggers layout when browser window is resized
            ...
            callbacks: {
                ...
                loadingError: function($message, xhr) {
                    ...
                    $message.load('nodes/NoResultBlock.php').html();
    ...
    Waterfall.prototype = {
        ...
        _initContainer: function() {
            ...
            this.$element.after('<div id="' + prefix + '-loading">' +options.loadingMsg+ '</div><div id="' + prefix + '-message"></div>');
