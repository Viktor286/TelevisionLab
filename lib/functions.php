...
function AdjustH1InfoOutput($getSet, $Mode, $tags) {
    ...
    $isSetActive = 0;
    if(preg_match("/c1/", $getSet)) {$SetTitleLine .= '<nobr><span class="type-tag"><nobr><img src="img/min-compositing.png" /> Compositing FX</span></nobr> + '; $isSetActive = 1;}
    if(preg_match("/d1/", $getSet)) {$SetTitleLine .= '<nobr><span class="type-tag"><nobr><img src="img/min-graphics.png" /> 3d Graphics</span></nobr> + '; $isSetActive = 1;}
    if(preg_match("/s1/", $getSet)) {$SetTitleLine .= '<nobr><span class="type-tag"><nobr><img src="img/min-simulation.png" /> Simulation</span></nobr> + '; $isSetActive = 1;}
    if(preg_match("/a1/", $getSet)) {$SetTitleLine .= '<nobr><span class="type-tag"><nobr><img src="img/min-animation.png" /> Animation</span></nobr> + '; $isSetActive = 1;}
    if(preg_match("/t1/", $getSet)) {$SetTitleLine .= '<nobr><span class="type-tag"><nobr><img src="img/min-rd_stop_motion.png" /> Stop Motion</span></nobr> + '; $isSetActive = 1;}
    if(preg_match("/v1/", $getSet)) {$SetTitleLine .= '<nobr><span class="type-tag"><nobr><img src="img/min-rd_video.png"  /></span> Video</nobr>'; $isSetActive = 1;}
